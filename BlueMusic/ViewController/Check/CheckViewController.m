...
- (void)viewDidLoad
{
    ...
    UIImage *logoimage = [UIImage imageNamed:@"test_header.png"];
    ...
    UIButton *btn0 = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 97, 113)];
    [btn0 setBackgroundImage:[UIImage imageNamed:@"test_VOC_btn.png"] forState:UIControlStateNormal];
    btn0.center = CGPointMake(width/2.0, 30 + 29 + logoimage.size.height + 113/2.0);
    [self.mScrollView addSubview:btn0];
    
    UIButton *btn1 = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 97, 113)];
    [btn1 setBackgroundImage:[UIImage imageNamed:@"test_temperature_btn.png"] forState:UIControlStateNormal];
    btn1.center = CGPointMake(width/2.0, btn0.frame.size.height + btn0.frame.origin.y + 24 + 113/2.0);
    [self.mScrollView addSubview:btn1];
    
    UIButton *btn2 = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 97, 113)];
    [btn2 setBackgroundImage:[UIImage imageNamed:@"test_humidity_btn.png"] forState:UIControlStateNormal];
...
- (void)btnAction:(UIButton*)btn
{
    ...
    TMPCheckViewController *controller = [[TMPCheckViewController alloc] init];
    controller.tag = btn.tag;
